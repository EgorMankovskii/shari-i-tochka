CONTACTS = {
    ...
    'manager_name': 'Макс',
    'address': 'Москва, улица Тушинская 17',
...
HOME_PAGE = {
    'hero_title': 'Воздушные шары, свежие цветы и всё для вашего праздника',
    'hero_text': (
        'Мы создаём атмосферу праздника с помощью воздушных шаров, свежих цветов и красивых композиций. '
        'У нас вы найдёте всё, чтобы сделать важный день ярче, теплее и радостнее. '
        'Каждый заказ мы собираем с любовью и вниманием к деталям. '
        'Нам важно, чтобы ваши эмоции были искренними, а праздник — по-настоящему особенным.'
    ),
    'hero_badges': ['Доставка от 30 минут', 'Фото перед отправкой', 'Без онлайн-оплаты'],
    'categories': [
        {
            'title': 'Цветы',
...
DELIVERY_INFO = {
    'preview': {
        ...
        'text': 'Заказы принимаются ежедневно. Бережно доставляем цветы и воздушные шары в интервале 30–60 минут.',
    },
    'steps': [
    ...
    'zones': [
        {'name': 'СЗАО', 'price': 'Бесплатно'},
        {'name': 'ЦАО', 'price': '300 ₽'},
        {'name': 'СВАО и ЮЗАО', 'price': '450 ₽'},
        {'name': 'ЮВАО', 'price': '600 ₽'},
    ],
    'notes': [
